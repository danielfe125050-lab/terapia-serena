    ...
    return (
        <>
            <button
                ...
                className="absolute top-6 right-6 z-50 p-3 bg-accent text-white rounded-full hover:bg-accent/90 transition-all shadow-xl hover:shadow-2xl hover:scale-105 border border-white/10 group"
            >
